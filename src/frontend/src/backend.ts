...
export class Backend implements backendInterface {
    ...
    async getPredictionStats(): Promise<bigint> {
    ...
    async getRecentPredictions(): Promise<Array<PredictionRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentPredictions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async predictPrice(arg0: PredictionInput): Promise<PredictionResult> {
        if (this.processError) {
            try {
                const result = await this.actor.predictPrice(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
